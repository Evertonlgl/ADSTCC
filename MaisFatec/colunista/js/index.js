...
$(document).ready(function(){
    ...
    setTimeout(function(){
        $.ajax({
            url: 'http://api.everlive.com/v1/eA9DgzMTcA6Adsgo/Colunista',
            type: "GET",
    ...
    setTimeout(function(){
        $.ajax({
            url: 'http://api.everlive.com/v1/eA9DgzMTcA6Adsgo/Tema',
            type: "GET",
            headers: {"Authorization" : "Bearer "+ chave},
            success: function(data){
                var  dataSource = new kendo.data.DataSource({
    ...
    setTimeout(function(){
        $.ajax({
            url: 'http://api.everlive.com/v1/eA9DgzMTcA6Adsgo/Postagem',
            type: "GET",
            headers: {"Authorization" : "Bearer "+ chave},
            success: function(data){
