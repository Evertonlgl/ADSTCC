...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="perfilTudo">
        <div id="perfilTopo">
            <img id="imgPerfilCapa" runat="server" src="img/linhas.jpg" class="perfilCapaFundo"/>
             <asp:Image ID="imgPerfilFoto" runat="server" CssClass="perfilFoto" Width="155px" Height="155px" />
        </div>
        <div id="perfilNome">
