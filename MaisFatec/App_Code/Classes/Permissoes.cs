...
public class Permissoes
{
    ...
    private Boolean _administradorPermissao;
    ...
    public Permissoes()
    {
        ...
        _dataPermissao = DateTime.Today;
        _motivoPermissao = string.Empty;
        _tempoPermissao = 0;
        _administradorPermissao = false;
    ...
    public Boolean AdministradorPermissao
    {
        get { return _administradorPermissao; }
        set { _administradorPermissao = value; }
    }
