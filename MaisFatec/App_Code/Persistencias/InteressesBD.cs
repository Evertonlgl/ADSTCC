...
*/
    ...
    public void InsertNovoUsr(List<Interesses> interessesLista, int idPerfil)
    {
            IDbConnection objConection = null;
            IDbCommand objComando = null;
            ...
            foreach (Interesses element in interessesLista)
	        {
                ...
                objConection = Mapped.Connection();
                objComando = Mapped.Command(sql, objConection);
                objComando.Parameters.Add(Mapped.Parameter("?int_descricao", element.InteressesDescricao));
                objComando.Parameters.Add(Mapped.Parameter("?int_tipo", element.InteressesTipo));
                objComando.Parameters.Add(Mapped.Parameter("?perf_id", idPerfil));
                objComando.Parameters.Add(Mapped.Parameter("?int_index", element.IndexInteresse));
                objComando.ExecuteNonQuery(); 
	        }
